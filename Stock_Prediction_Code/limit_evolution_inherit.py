...
from leea_inherit import leea_inherit
import check_LEEA
from jpg import LEEA_jpg1, LEEA_jpg2, LEEA_jpg3, LEEA_jpg4_inherit, LEEA_jpg5, LEEA_jpg6,\
    LEEA_jpg7, LEEA_jpg8, LEEA_elitist_jpg9, LEEA_elitist_jpg10, LEEA_elitist_jpg11, LEEA_elitist_jpg12

p = net_params.net_params()


def train():  # 开始训练（（（接口）））
    leea_inherit.leea_experiment()
...
def leea_jpg4_inherit():
    LEEA_jpg4_inherit.child_screen()
...
def leea_elitist_jpg9():
    LEEA_elitist_jpg9.child_screen()


def leea_elitist_jpg10():
    LEEA_elitist_jpg10.child_screen()


def leea_elitist_jpg11():
    LEEA_elitist_jpg11.child_screen()


def leea_elitist_jpg12():
    LEEA_elitist_jpg12.child_screen()
...
def child_screen():
    ...
    b4 = tk.Button(root, text="sexual", command=leea_jpg4_inherit, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    ...
    b9 = tk.Button(root, text="evaluate_all", command=leea_elitist_jpg9, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b9.place(x=440, y=312)
    b10 = tk.Button(root, text="divide", command=leea_elitist_jpg10, width=22, height=1,
                    font=('Cascadia Code ExtraLight', 10))
    b10.place(x=440, y=346)
    b11 = tk.Button(root, text="get_next_generation", command=leea_elitist_jpg11, width=22, height=1,
                    font=('Cascadia Code ExtraLight', 10))
    b11.place(x=440, y=380)
    b12 = tk.Button(root, text="evolve", command=leea_elitist_jpg12, width=22, height=1,
                    font=('Cascadia Code ExtraLight', 10))
    b12.place(x=440, y=414)
