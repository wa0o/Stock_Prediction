...
def child_screen():
    ...
    b5 = tk.Button(root, text="asexual", command=leea_jpg5, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b5.place(x=40, y=160)
    b6 = tk.Button(root, text="create_first_generation", command=leea_jpg7, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b6.place(x=40, y=190)
    b7 = tk.Button(root, text="produce_offspring", command=leea_jpg8, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b7.place(x=40, y=220)
