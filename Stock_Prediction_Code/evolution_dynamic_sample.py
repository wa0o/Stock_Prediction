...
import training_evolution
from ea_dynamic_sample import net_params
from ea_dynamic_sample import ea_dynamic_sample
import check_EA
from jpg import EA_dynamic_sample_jpg1, EA_dynamic_sample_jpg2, EA_dynamic_sample_jpg3,\
    EA_dynamic_sample_jpg4, EA_dynamic_sample_jpg5, EA_dynamic_sample_jpg6,\
    EA_dynamic_sample_jpg7, EA_dynamic_sample_jpg8, EA_dynamic_sample_jpg9

p = net_params.net_params()


def train():  # 开始训练（（（接口）））
    ea_dynamic_sample.leea_experiment()
...
def ea_dynamic_sample_jpg1():
    EA_dynamic_sample_jpg1.child_screen()


def ea_dynamic_sample_jpg2():
    EA_dynamic_sample_jpg2.child_screen()


def ea_dynamic_sample_jpg3():
    EA_dynamic_sample_jpg3.child_screen()


def ea_dynamic_sample_jpg4():
    EA_dynamic_sample_jpg4.child_screen()


def ea_dynamic_sample_jpg5():
    EA_dynamic_sample_jpg5.child_screen()


def ea_dynamic_sample_jpg6():
    EA_dynamic_sample_jpg6.child_screen()


def ea_dynamic_sample_jpg7():
    EA_dynamic_sample_jpg7.child_screen()


def ea_dynamic_sample_jpg8():
    EA_dynamic_sample_jpg8.child_screen()


def ea_dynamic_sample_jpg9():
    EA_dynamic_sample_jpg9.child_screen()
...
def child_screen():
    ...
    label12_ = tk.Label(root, text="process_num:", font=('Cascadia Code ExtraLight', 10))
    label12_.place(x=40, y=520)
    ...
    label24_ = tk.Label(root, text="default : 8 (进程的数量)", font=('Baskerville Old Face', 10))
    label24_.place(x=40, y=540)
    ...
    text12_ = tk.Text(root, width=10, height=1, font=('幼圆', 10))
    text12_.place(x=220, y=525)
    ...
    def get_weight12_():
        weight12_ = text12_.get("1.0", "end-1c")
        if weight12_ == '':
            weight12_ = 8
        return weight12_

    # def next_page_jump():
    #     training_evolution.child_screen()
    ...
    def next_page():
        ...
        p.get_process_num(get_weight12_())
    ...
    b1 = tk.Button(root, text="node_update", command=ea_dynamic_sample_jpg1, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b1.place(x=440, y=40)
    b2 = tk.Button(root, text="evaluate", command=ea_dynamic_sample_jpg2, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b2.place(x=440, y=74)
    b3 = tk.Button(root, text="get_parent_index", command=ea_dynamic_sample_jpg3, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b3.place(x=440, y=108)
    b4 = tk.Button(root, text="sexual", command=ea_dynamic_sample_jpg4, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b4.place(x=440, y=142)
    b5 = tk.Button(root, text="asexual", command=ea_dynamic_sample_jpg5, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b5.place(x=440, y=176)
    b6 = tk.Button(root, text="get_next_generation", command=ea_dynamic_sample_jpg6, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b6.place(x=440, y=210)
    b7 = tk.Button(root, text="create_first_generation", command=ea_dynamic_sample_jpg7, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b7.place(x=440, y=244)
    b8 = tk.Button(root, text="produce_offspring", command=ea_dynamic_sample_jpg8, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b8.place(x=440, y=278)
    b9 = tk.Button(root, text="evaluate_all", command=ea_dynamic_sample_jpg9, width=22, height=1,
                   font=('Cascadia Code ExtraLight', 10))
    b9.place(x=440, y=312)
